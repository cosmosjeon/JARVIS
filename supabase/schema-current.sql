...
CREATE TABLE IF NOT EXISTS "public"."nodes" (
    ...
    "node_type" "text" DEFAULT 'question'::"text" NOT NULL,
    "memo_parent_id" "text",
    "memo_title" "text",
    "memo_content" "text",
    "memo_metadata" "jsonb",
    CONSTRAINT "nodes_node_type_check" CHECK (("node_type" = ANY (ARRAY['question'::"text", 'memo'::"text"]))),
    CONSTRAINT "nodes_status_check" CHECK (("status" = ANY (ARRAY['placeholder'::"text", 'asking'::"text", 'answered'::"text", 'draft'::"text", 'memo'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."tree_viewport_states" (
    ...
    "user_id" "uuid" NOT NULL,
    "tree_id" "text" NOT NULL,
    "viewport_data" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "created_at" bigint DEFAULT (EXTRACT(epoch FROM "now"()) * (1000)::numeric) NOT NULL,
    "updated_at" bigint DEFAULT (EXTRACT(epoch FROM "now"()) * (1000)::numeric) NOT NULL
);


ALTER TABLE "public"."tree_viewport_states" OWNER TO "postgres";
...
CREATE INDEX "idx_folders_parent_id" ON "public"."folders" USING "btree" ("parent_id") WHERE ("deleted_at" IS NULL);



CREATE INDEX "idx_folders_user_id" ON "public"."folders" USING "btree" ("user_id") WHERE ("deleted_at" IS NULL);



CREATE INDEX "idx_tree_viewport_states_updated_at" ON "public"."tree_viewport_states" USING "btree" ("updated_at" DESC);
...
CREATE INDEX "nodes_memo_parent_idx" ON "public"."nodes" USING "btree" ("memo_parent_id");
...
CREATE INDEX "nodes_user_tree_idx" ON "public"."nodes" USING "btree" ("user_id", "tree_id");
...
ALTER TABLE ONLY "public"."nodes"
    ADD CONSTRAINT "nodes_memo_parent_id_fkey" FOREIGN KEY ("memo_parent_id") REFERENCES "public"."nodes"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."nodes"
    ADD CONSTRAINT "nodes_tree_id_fkey" FOREIGN KEY ("tree_id") REFERENCES "public"."trees"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."tree_viewport_states"
    ADD CONSTRAINT "tree_viewport_states_tree_id_fkey" FOREIGN KEY ("tree_id") REFERENCES "public"."trees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."tree_viewport_states"
    ADD CONSTRAINT "tree_viewport_states_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."trees"
    ADD CONSTRAINT "trees_folder_id_fkey" FOREIGN KEY ("folder_id") REFERENCES "public"."folders"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."trees"
    ADD CONSTRAINT "trees_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "Nodes are owner writable" ON "public"."nodes" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Trees are owner readable" ON "public"."trees" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Trees are owner writable" ON "public"."trees" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Trees owner delete" ON "public"."trees" FOR DELETE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Trees owner update" ON "public"."trees" FOR UPDATE USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can delete their own tree viewport states" ON "public"."tree_viewport_states" FOR DELETE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can insert their own tree viewport states" ON "public"."tree_viewport_states" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can update their own tree viewport states" ON "public"."tree_viewport_states" FOR UPDATE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view their own tree viewport states" ON "public"."tree_viewport_states" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
GRANT ALL ON TABLE "public"."tree_viewport_states" TO "anon";
GRANT ALL ON TABLE "public"."tree_viewport_states" TO "authenticated";
GRANT ALL ON TABLE "public"."tree_viewport_states" TO "service_role";
